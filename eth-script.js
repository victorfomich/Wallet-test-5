...
function createTransactionElement(transaction) {
    ...
    div.innerHTML = `
        ...
        <div class="transaction-info">
            ...
            <div class="transaction-details"><span class="transaction-network">ETH</span><span>${dateStr}</span></div>
        </div>
        <div class="transaction-amount">
            <div class="transaction-crypto ${amountClass}">${amountSign}${amount.toFixed(6)} ETH</div>
